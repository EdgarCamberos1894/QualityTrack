...
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Documentos consultados correctamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.nocountry.qualitytrack.shared.response.ApiResponse.class), examples = @ExampleObject(value = RequestDocumentApiExamples.DOCUMENTS_RETRIEVED))),
...
public @interface ListRequestDocumentsApiDocs {
}
