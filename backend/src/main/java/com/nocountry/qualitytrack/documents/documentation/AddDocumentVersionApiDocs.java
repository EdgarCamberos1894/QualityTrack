...
@Documented
@Operation(
        summary = "Agregar versión de documento",
        description = "Agrega una nueva versión al documento sin modificar ni eliminar versiones anteriores. El número se calcula de forma secuencial y el documento se bloquea durante la operación para evitar versiones duplicadas por concurrencia."
)
@ApiResponses({
        @ApiResponse(
                responseCode = "201",
                ...
                content = @Content(
                        ...
                        examples = @ExampleObject(value = DocumentApiExamples.DOCUMENT_VERSION_CREATED)
                )
        ),
...
public @interface AddDocumentVersionApiDocs {
}
