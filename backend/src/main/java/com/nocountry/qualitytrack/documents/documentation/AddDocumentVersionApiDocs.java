...
@Operation(
        ...
        description = "Agrega una nueva versión al documento indicado dentro de la solicitud sin modificar ni eliminar versiones anteriores. El backend valida que el documento pertenezca realmente al expediente asociado a esa solicitud y bloquea el documento durante la operación para evitar números de versión duplicados por concurrencia."
)
@ApiResponses({
        @ApiResponse(
                responseCode = "201",
